...
export type JSONElement = (Record<string, any> & {
    _isJSONElement: true;
...
export declare class JSONXPathResult {
    ...
    constructor(properties?: Partial<XPathResult> & {
        snapshotItems?: JSONElement[];
    });
    get booleanValue(): boolean | undefined;
    get invalidIteratorState(): boolean;
    get numberValue(): number | undefined;
    get resultType(): number;
    get singleNodeValue(): Node | null | undefined;
    get snapshotLength(): number;
    get stringValue(): string;
    snapshotItem(index: number): JSONElement;
    iterateNext(): JSONElement | undefined;
}
export declare function JSONLDParser<BaseType extends MixinConstructor>(Base: BaseType): {
    new (...args: any[]): {
        ...
        findInJSONLD(xpathExpression: string, contextNode?: Record<string, any> | null, namespaceResolver?: Record<string, string> | null, resultType?: number, result?: any): JSONXPathResult;
        ...
        find(query: string, contextNode?: import("./redblue-video.js").$Element | undefined): import("./redblue-video.js").HTMLXPathResult | JSONXPathResult;
        accessKey: string;
    ...
    customJSONSearchUtility?: ((xpathExpression: string, contextNode?: Record<string, any> | null, namespaceResolver?: Record<string, string> | null, resultType?: number, result?: any) => JSONXPathResult) | undefined;
} & BaseType;
//# sourceMappingURL=parser-json-ld.d.ts.map