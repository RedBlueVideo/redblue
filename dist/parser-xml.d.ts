...
import { $Element, Annotation, Choice } from "./redblue-video.js";
import { MixinConstructor } from "./util.js";
export declare function XMLParser<BaseType extends MixinConstructor>(Base: BaseType): {
    new (...args: any[]): {
        XML: {
        ...
        resolveCSSNamespacePrefixFromXML(defaultPrefix?: string): any;
        getAnnotationFromChoiceElement($child: $Element): Choice;
        getAnnotationsFromXML<Cast extends Annotation[] = Annotation[]>(xpath?: string, contextNode?: $Element): Cast;
        ...
        findInJSONLD?(xpathExpression: string, contextNode?: Record<string, any> | undefined, namespaceResolver?: Record<string, string> | null | undefined, resultType?: number | undefined, result?: any): import("./parser-json-ld.js").JSONXPathResult;
        ...
        log: (...args: any[]) => void;
        mediaQueue: import("./redblue-video.js").MediaQueueObject[];
        mimeTypes: Record<"mp4" | "webm", "video/mp4" | "video/webm">;
        MSE?: import("./player-mse.js").MSE | undefined;
        player: YT.Player;
        resolveCSSNamespacePrefixFromJSONLD?(defaultPrefix?: string | undefined): Promise<string>;
        ...
        fetchMedia(mediaQueueObject: import("./redblue-video.js").MediaQueueObject): void;
        _handleMediaFromFileElements(xpath: string, callback: (mediaQueueObject: import("./redblue-video.js").MediaQueueObject) => void): void;
        ...
        _handleMediaFromPlaylistItem($playlistItem: $Element, mediaCallback: ($mediaElement: $Element) => void, choicePromptCallback?: (($mediaElement: $Element) => void) | undefined): void;
        ...
        applyAnnotationStyles(loopObject?: Annotation[], parentIndex?: number | undefined): void;
        ...
        createHotspot(annotation: Annotation, index: string | number, $target?: HTMLElement): void;
        ...
        find(query: string, contextNode?: $Element | undefined): import("./redblue-video.js").HTMLXPathResult | import("./parser-json-ld.js").JSONXPathResult;
        accessKey: string;
        ...
        role: string | null;
        animate(keyframes: Keyframe[] | PropertyIndexedKeyframes | null, options?: number | KeyframeAnimationOptions | undefined): globalThis.Animation;
        getAnimations(options?: GetAnimationsOptions | undefined): globalThis.Animation[];
...
//# sourceMappingURL=parser-xml.d.ts.map