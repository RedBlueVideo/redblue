...
import RedBlueVideo from "./redblue-video";
...
export class JSONXPathResult extends XPathResult {
  ...
  constructor( properties: Partial<XPathResult> & { snapshotItems?: Node[] } = {} ) {
    super();
...
export class RedBlueJSONLDParser extends RedBlueVideo {
